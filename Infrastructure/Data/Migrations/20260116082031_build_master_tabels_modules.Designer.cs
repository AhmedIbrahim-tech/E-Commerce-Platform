...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260116082031_build_master_tabels_modules")]
    partial class build_master_tabels_modules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Discount", b =>
                {
                    ...
                    b.Property<Guid?>("DiscountPlanId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("discount_plan_id");
            ...
            modelBuilder.Entity("Domain.Entities.DiscountPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("id");
                    ...
                    b.ToTable("discount_plans", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Discount", b =>
                {
                    b.HasOne("Domain.Entities.DiscountPlan", "DiscountPlan")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.UnitOfMeasure", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Domain.Entities.VariantAttributeValue", b =>
                {
                    b.HasOne("Domain.Entities.VariantAttribute", "VariantAttribute")
                        .WithMany("Values")
